...
public class Fork extends MainFrame {
  public Fork() {
  }
  protected void perform() {
    ...
    while (steps < 100) {
      if (steps % 10 == 0) {
        ...
        // check if destination position is allowed. 
        // if so, then create vehicle and add vehicle to cell at starting position 
        if (isAllowedRow(10) && isAllowedCol(1) && isAllowedRow(22) && isAllowedCol(29)) {
          // check if vehicle is drivable here 
          if (world[10][1].isDrivable(Direction.east)) {
            // create a new vehicle 
            Vehicle vehicle = new Vehicle(new Position(10, 1), new Position(22, 29), Direction.east, Direction.east, Direction.south);
