                  ...
                  TemplateContext context4 = context3.subContext();
                  {
                    ...
                    try {
                      TemplateContext context5 = context4.subContext();
                      {
                        ...
                        try {
                          tnode6.setReference(myAssociationLinks[0], SReference.create(myAssociationLinks[0], tnode6, PersistenceFacade.getInstance().createModelReference("r:f5e9b11f-5073-4786-8ed1-a9e42307c3f8(JavaKaja.runtime)"), PersistenceFacade.getInstance().createNodeId("3210697320273550615")));
                        } finally {
                        }
              ...
              }
              {
                ...
                try {
                  TemplateContext context6 = context3.subContext();
                  {
                    ...
                    try {
                      tnode8.setReference(myAssociationLinks[0], SReference.create(myAssociationLinks[0], tnode8, PersistenceFacade.getInstance().createModelReference("r:f5e9b11f-5073-4786-8ed1-a9e42307c3f8(JavaKaja.runtime)"), PersistenceFacade.getInstance().createNodeId("3210697320273648281")));
                      TemplateContext context7 = context6.subContext();
                      {
                        final SNode tnode9 = environment.createOutputNode(myConcepts[6]);
                        try {
                          SNodeAccessUtil.setProperty(tnode9, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_3210697320273648397(new PropertyMacroContext(context7, "0", propertyMacro_isi7q0_c0a0c0a0b0c0b0b0b0c0b0b0b0b0c0e))));
                        } finally {
                        }
                    ...
                    tnode7.addChild(myAggregationLinks[4], tnode8);
                    // TODO validate child 
                  }
                  {
                    final SNode tnode10 = environment.createOutputNode(myConcepts[4]);
                    try {
                      tnode10.setReference(myAssociationLinks[0], SReference.create(myAssociationLinks[0], tnode10, PersistenceFacade.getInstance().createModelReference("r:f5e9b11f-5073-4786-8ed1-a9e42307c3f8(JavaKaja.runtime)"), PersistenceFacade.getInstance().createNodeId("3210697320273648203")));
                      TemplateContext context8 = context6.subContext();
                      {
                        final SNode tnode11 = environment.createOutputNode(myConcepts[6]);
                        try {
                          SNodeAccessUtil.setProperty(tnode11, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_3210697320273648406(new PropertyMacroContext(context8, "0", propertyMacro_isi7q0_c0a0c0a0b0c0b0c0b0c0b0b0b0b0c0e))));
                        } finally {
                        }
                    ...
                    tnode7.addChild(myAggregationLinks[5], tnode10);
                    // TODO validate child 
                  }
                } finally {
                }
              ...
              }
              {
                ...
                try {
                  TemplateContext context9 = context3.subContext();
                  {
                      ...
                      TemplateContext context10 = context9.subContext();
                      {
                        ...
                        try {
                          TemplateContext context11 = context10.subContext();
                          {
                            ...
                            try {
                              tnode15.setReference(myAssociationLinks[0], SReference.create(myAssociationLinks[0], tnode15, PersistenceFacade.getInstance().createModelReference("r:f5e9b11f-5073-4786-8ed1-a9e42307c3f8(JavaKaja.runtime)"), PersistenceFacade.getInstance().createNodeId("3308300503039580739")));
                              TemplateContext context12 = context11.subContext();
                              {
                                final SNode tnode16 = environment.createOutputNode(myConcepts[7]);
                                try {
                                  SNodeAccessUtil.setProperty(tnode16, myProperties[1], "Attempted to destroy wall outside of the playground!");
                                } finally {
                                }
                    ...
                    tnode12.addChild(myAggregationLinks[7], tnode13);
                    // TODO validate child 
                  }
                } finally {
                }
                tnode3.addChild(myAggregationLinks[8], tnode12);
                // TODO validate child 
              }
            } finally {
            }
