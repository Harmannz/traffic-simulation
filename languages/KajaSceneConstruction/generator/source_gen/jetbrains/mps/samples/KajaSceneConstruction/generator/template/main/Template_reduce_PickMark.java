...
public class Template_reduce_PickMark extends TemplateDeclarationBase {
      ...
      TemplateContext context1 = context.subContext();
      {
        ...
        try {
                  ...
                  TemplateContext context4 = context3.subContext();
                  {
                    ...
                    try {
                      ...
                      TemplateContext context5 = context4.subContext();
                      {
                        ...
                        try {
                          SNodeAccessUtil.setProperty(tnode7, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_3210697320273648470(new PropertyMacroContext(context5, "0", propertyMacro_mi0eld_c0a0c0a0b0c0b0b0b0c0b0b0b0b0c0e))));
                        } finally {
                        }
                  ...
                  }
                  {
                    ...
                    try {
                      ...
                      TemplateContext context6 = context4.subContext();
                      {
                        ...
                        try {
                          SNodeAccessUtil.setProperty(tnode9, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_3210697320273648479(new PropertyMacroContext(context6, "0", propertyMacro_mi0eld_c0a0c0a0b0c0b0c0b0c0b0b0b0b0c0e))));
                        } finally {
                        }
                          ...
                          TemplateContext context9 = context8.subContext();
                          {
                            ...
                            try {
                              ...
                              TemplateContext context10 = context9.subContext();
                              {
                                ...
                                try {
                                  SNodeAccessUtil.setProperty(tnode14, myProperties[1], "Attempted to pick marks outside of the playground!");
                                } finally {
                                }
          ...
          }
          {
            ...
            tnode2.addChild(myAggregationLinks[6], tnode15);
            // TODO validate child 
          }
        } finally {
        }
  ...
  protected SConcept[] initConcepts() {
    ...
    rv[8] = MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, "jetbrains.mps.baseLanguage"), 0xf8cc56b215L, "Statement");
    return rv;
  }
  @Override
